...
namespace lab1_filters 
{
    ...
    public partial class MainWindow : Window {
        ...
        private void Window_Activated(object sender, EventArgs e) {
            ...
            //canvas cache
            //UIElement[] temparr = new UIElement[this.functionCanvas.Children.Count];
            //this.functionCanvas.Children.CopyTo(temparr, 0);

            //foreach (UIElement elem in temparr)
            //    this.functionCoordinateLines.Add(elem.DeepClone());
        ...
        private void saveFilterButton_Click(object sender, RoutedEventArgs e) 
        {
            ...
            customFilter.CustomFunction = this.customFunctionArrayFromCanvas();
        ...
        private void RenderValue(System.Drawing.Point point) 
        {
            ...
            Canvas.SetTop(value, x-(double)width/2);
            Canvas.SetLeft(value, y-(double)width/2);
        ...
        public void PointDragged() {
            ...
            foreach (UIElement element in this.functionCanvas.Children) {
                if (element is Ellipse) {
                    ...
                    this.functionPoints.Add(new System.Drawing.Point((int)childToParentCoordinates.Y, (int)childToParentCoordinates.X));
                }
            }
        ...
        private void filtersComboBox_SelectionChanged(object sender, SelectionChangedEventArgs e) {
            ...
            if (filter is ConvolutionFilter) {
            ...
            } else if(filter is IFunctionFilterOffset) {
                ...
                this.coeffTextField.Text = "" + ((IFunctionFilterOffset)filter).Offset;
